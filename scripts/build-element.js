...
export default async function buildElement() {
  ...
  const esmBundleContent = elementContent
    ...
    .replace('//IMPORT_SWIPER', `import Swiper from '@abasb75/swiperjs/bundle';`)
  ...
  const esmContent = elementContent
    ...
    .replace('//IMPORT_SWIPER', `import Swiper from '@abasb75/swiperjs';`)
    .replace('//EXPORT', `export { SwiperContainer, SwiperSlide, register };`);
    ...
    const bundle = await rollup({
      ...
      plugins: [
        replace({
          ...
          [`import Swiper from '@abasb75/swiperjs/bundle';`]: `import Swiper from '../swiper-bundle.esm.js';`,
          [`import Swiper from '@abasb75/swiperjs';`]: `import Swiper from '../swiper.esm.js';`,
